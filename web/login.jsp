                    ...
                    <div class="card card1 p-3">
                        ...
                        <div class="input-field d-flex flex-column mt-3"> 
                            <form name="loginForm" action="LoginServlet" method="post" onsubmit="return checkSend()">
                                Nhập email<input class="form-control" placeholder="Enter your email" type="text" name="username"/><br/>
                                <div id="divCheckEmail"></div>
                                Nhập mật khẩu<input class="form-control" placeholder="Enter your password" type="password" name="pass"/><br/>            

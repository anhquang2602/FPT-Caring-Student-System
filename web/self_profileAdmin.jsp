                            ...
                            <div class="row">
                                <div>
                                    <ul class="breadcrumb bg-white">
                                        ...
                                        <li><a href="UpdateAdminProfile">Hồ sơ của tôi</a></li>                                    
                                    </ul>
                                </div>
                                <div class="col-md-4">
                                    <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                                        <div class="mt-5">
                                            <img class="rounded-circle justify-content-center" height="200px" width="200px" 
                                                 ...
                                                 id="output">
                                            <input style="padding-left: 80px" type="file" name="avatarImage" accept="image/*" onchange="loadFile(event)" class="form-control-file mt-3 p-3 ml-5" id="avatarImg">
                                        </div>
                                        <div id="divCheckImg"></div>
                                        <div class="mt-5">
                                            <strong class="text-right fs12">${admin.email}</strong>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="p-3 py-5">
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                                ...
                                                <label class="labels" id="genderlable" hidden="">${admin.gender}</label><br/>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-md-11">
                                                ...
                                                <input type="text" name="linkFb" class="form-control" value="${admin.linkFb}">
                                            </div>
                                            <div class="col-md-1 mt-4 p-2">
                                                <a class="login-facebook-icon" style="height: 40px; width: 40px; margin-left: calc(100%-20px)" href="${admin.linkFb}" title="" target="_blank">f</a>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-md-12">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" name="addressDetail" class="form-control"value="${admin.address}">
                                                </div>
                                            </div>

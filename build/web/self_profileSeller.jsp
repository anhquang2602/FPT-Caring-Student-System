                        ...
                        <div class="row">
                            <div>
                                <ul class="breadcrumb bg-white">
                                    ...
                                    <li><a href="UpdateSellerProfile">My Profile</a></li>                                    
                                </ul>
                            </div>
                            ...
                            <div class="col-md-8">
                                <div class="p-3 py-5">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        <div class="col-md-6"><label class="labels">First Name</label><input type="text" name="firstName" class="form-control" value="${seller.firstName}" ></div>
                                        <div class="col-md-6"><label class="labels">Last Name</label><input type="text" name="lastName" class="form-control" value="${seller.lastName}" ></div>
                                    </div>
                                    <div class="row mt-3">
